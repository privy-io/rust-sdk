...
/**You should use this struct via [`PrivyLibninjaClient::delete_v1_policies_rules_by_rule_id`].

On request success, this will return a [`DeleteV1PoliciesRulesByRuleIdResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DeleteV1PoliciesRulesByRuleIdRequest {
    pub policy_id: String,
    pub privy_app_id: String,
    pub privy_authorization_signature: Option<String>,
    pub rule_id: String,
}
impl FluentRequest<'_, DeleteV1PoliciesRulesByRuleIdRequest> {
...
for FluentRequest<'a, DeleteV1PoliciesRulesByRuleIdRequest> {
    type Output = httpclient::InMemoryResult<
        crate::model::DeleteV1PoliciesRulesByRuleIdResponse,
    >;
...
Delete a rule by policy ID and rule ID.*/
    pub fn delete_v1_policies_rules_by_rule_id(
        &self,
        policy_id: &str,
        privy_app_id: &str,
        rule_id: &str,
    ) -> FluentRequest<'_, DeleteV1PoliciesRulesByRuleIdRequest> {
        FluentRequest {
            client: self,
            params: DeleteV1PoliciesRulesByRuleIdRequest {
