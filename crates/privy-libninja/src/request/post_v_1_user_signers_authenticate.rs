...
/**You should use this struct via [`PrivyLibninjaClient::post_v1_user_signers_authenticate`].

On request success, this will return a [`PostV1UserSignersAuthenticateResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PostV1UserSignersAuthenticateRequest {
    pub encryption_type: Option<String>,
    pub privy_app_id: String,
    pub recipient_public_key: Option<String>,
    pub user_jwt: String,
}
impl FluentRequest<'_, PostV1UserSignersAuthenticateRequest> {
...
for FluentRequest<'a, PostV1UserSignersAuthenticateRequest> {
    type Output = httpclient::InMemoryResult<
        crate::model::PostV1UserSignersAuthenticateResponse,
    >;
    type IntoFuture = ::futures::future::BoxFuture<'a, Self::Output>;
    fn into_future(self) -> Self::IntoFuture {
        Box::pin(async move {
            let url = "/v1/user_signers/authenticate";
...
impl crate::PrivyLibninjaClient {
    ...
    pub fn post_v1_user_signers_authenticate(
        &self,
        privy_app_id: &str,
        user_jwt: &str,
    ) -> FluentRequest<'_, PostV1UserSignersAuthenticateRequest> {
        FluentRequest {
            client: self,
            params: PostV1UserSignersAuthenticateRequest {
