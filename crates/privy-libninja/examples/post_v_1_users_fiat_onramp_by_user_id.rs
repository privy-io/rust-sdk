...
use privy_libninja::request::post_v_1_users_fiat_onramp_by_user_id::PostV1UsersFiatOnrampByUserIdRequired;
#[tokio::main]
async fn main() {
    ...
    let response = client
        .post_v1_users_fiat_onramp_by_user_id(PostV1UsersFiatOnrampByUserIdRequired {
            amount,
            destination,
            privy_app_id,
            provider,
